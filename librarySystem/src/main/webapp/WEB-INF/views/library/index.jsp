...
<body class="is-preload">
	...
	<div id="wrapper">
		...
		<section id="one" class="wrapper style2 spotlights">
			<section>
				<a href="#" class="image"><img
					src="${pageContext.request.contextPath}/resources/images/202004211422083541_3.jpg"
			...
			<section>
				<a href="#" class="image"><img
					src="${pageContext.request.contextPath}/resources/images/37572_31732_5246.jpg"
					alt="" data-position="top center" /></a>
				<div class="content">
					<div class="inner">
						<h2>책 반납하기</h2>
						<p>별도의 사정으로 책이 회손됐을 경우 매니저님께 말씀해주세요. 7일 이내로 반납한 경우가 아닐 시 별도의
							불이익이 있을 수 있습니다.</p>
						<ul class="actions">
		...
		<section id="two" class="wrapper style3 fade-up">
			<div class="inner">
				<h2>대여 기록 조회</h2>
				<p>내가 빌리고 싶은 책이 혹시 없다면, 대여기록을 살펴보세요. 혹은 어떤 책을 골라야할지 모르겠다면 다른사람들은
					어떤 책들을 위주로 많이 대여했는지 살펴보세요!</p>
				<div class="features">
					<section>
							...
							<div class="fields">
								<div class="field half">
									<label for="name">ID</label> <input type="text"
										name="managerId" id="name" />
								</div>
								<div class="field half">
									<label for="email">Password</label> <input type="password"
										name="managerPw" id="email" />
								</div>
							</div>
							<ul>
								<li><input type="submit" class="button submit"
									value="Login"></a></li>
							</ul>
						</form>
					</section>
