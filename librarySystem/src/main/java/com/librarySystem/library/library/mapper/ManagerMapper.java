...
public interface ManagerMapper {
	...
	/**
	 * 등록된 책 총 갯수를 구하기 위한 쿼리문
	 * @return 등록된 책 총 갯수 int
	 */
	int getCount();

	/**
	 * 등록된 책 목록 List를 가져오고 검색 값이 있을 경우 검색 값을 목록 List를 가져오는 쿼리문
	...
	/**
	 * 등록된 책 목록 List, 검색 값이 있을 경우 검색 값을 목록 List 목록의 총 갯수 값을 구하기 위한 쿼리문
	 * @param cri 페이징 및 검색 타입, 검색 값 입력 위한 파라미터
	...
	/**
	 * 반납 상태가 아닌 책들 목록 List를 가져오기 위한 쿼리문
